...
public class Goods implements Serializable{
    ...
    public void setTestAA(String testAA) {
        this.testAA = testAA;
    }
    ...
    public void setTestBB(String testBB) {
        this.testBB = testBB;
    }
    ...
    public Goods(int id, int subSiteId, String eShopSubsiteId, int productId, int productStyleId, int stock, int limitStock, BigDecimal salesPrice, BigDecimal costPrice, BigDecimal marketPrice, int shelfStatus, Date shelfTime, int points, int initSalesVolume, boolean isDefault, Date createTime, int createUser, Date lastModifyTime, int lastModifyUser, int status, String testAA, String testBB) {
        this.id = id;
        this.subSiteId = subSiteId;
        this.eShopSubsiteId = eShopSubsiteId;
        this.productId = productId;
